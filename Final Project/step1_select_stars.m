% Used to select stars for the full dataset of TOIs and non-TOIs by 
% combining the list of ~1k TOIs with twice as many entries from the CTL 
% with the highest priority that are not in the list of TOIs.
function step1_select_stars()
    % Load datasets
